...
from detection import calculate_heading_matrix, detect_vessel_anomalies, ANGLE_DIFF_ANOMALY
...
class TestHeadingAnomalyDetection(unittest.TestCase):
    def create_test_vessel_data(self, headings_mismatch=False):
        ...
        if headings_mismatch:
            data['Heading'] = [45.0, 45.0, 45.0 + ANGLE_DIFF_ANOMALY + 10, 45.0, 45.0 + ANGLE_DIFF_ANOMALY + 15]
